...
• AstryxDateTimeInput date + time     props: { label?:string, value:string (e.g. "Aug 16, 2026 · 10:30"), placeholder:string, month:string, selectedDay:number, times:string (comma-separated), selectedTime:string, open:boolean, invalid:boolean, disabled:boolean, required:boolean }
• AstryxDateRangeInput date range     props: { label?:string, startValue:string, endValue:string, startPlaceholder:string, endPlaceholder:string, month:string, rangeStart:number (1-31), rangeEnd:number (1-31), open:boolean, invalid:boolean, disabled:boolean, required:boolean }
...
— ADVANCED SELECTION & SEARCH —
• AstryxTypeahead      search-as-you-type  props: { label?:string, query:string (typed text), placeholder:string, suggestions:string (comma-separated), highlighted:string (must match one suggestion), open:boolean, invalid:boolean, disabled:boolean, required:boolean }
...
• AstryxPowerSearch    search bar with filters props: { placeholder:string, query:string, filters:string (comma-separated "key:value" chips), resultCount:string (e.g. "42 results"), suggestions:string (comma-separated), open:boolean, disabled:boolean }
